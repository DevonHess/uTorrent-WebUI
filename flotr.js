var Flotr = (function() {
	...
	function i(B, S, C) {
		...
		function p() {
			this.series[0].color = getComputedStyle(document.body).getPropertyValue('--speedup');
			this.series[1].color = getComputedStyle(document.body).getPropertyValue('--speeddown');
			this.options.grid.color = getComputedStyle(document.body).getPropertyValue('--speedbor');
			this.options.grid.tickColor = getComputedStyle(document.body).getPropertyValue('--speedboralt');
			z();
			E();
			Q(xaxis, r.xaxis);
			x();
